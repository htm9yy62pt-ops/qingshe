...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { name: '家', href: '/reality', icon: DocumentTextIcon }, // Changed from '我的现实' to '家'
    { name: '广场', href: '/square', icon: Squares2X2Icon },
    { name: '统计', href: '/stats', icon: ChartBarIcon },
    { name: '我的', href: '/profile', icon: UserIcon },
  ];

  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-3 px-4 z-10">
